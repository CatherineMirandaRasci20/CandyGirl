...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "candygirl.py"
 
        #Name of program
        self.project_name = "CandyGirl"
 
        #Project url
        self.project_url = "http://catherinerasci.github.io/CandyGirl"
        ...
        #Auhor of program
        self.author_name = "Me"
        self.author_email = "catherinemirandarasci@yahoo.com.ph"
        self.copyright = "Copyright (c) 2015."
 
        #Description
        self.project_description = "Generate and keep yourself away from candy. Candy Girl inspired from the game known as Dodger by Al Sweigart"
